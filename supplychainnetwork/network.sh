...
function networkDown() {
  ...
  # stop org3 containers also in addition to org4 and org5, in case we were running sample to add org3
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.example.com docker_peer0.org4.example.com docker_peer0.org5.example.com
