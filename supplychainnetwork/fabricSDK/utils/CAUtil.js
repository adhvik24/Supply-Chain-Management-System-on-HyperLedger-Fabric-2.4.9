...
const produceradminUserId = 'admin';
const produceradminUserPasswd = 'adminpw';
...
exports.enrollAdmin = async (caClient, wallet, orgMspId) => {
    try {
        ...
        if (orgMspId == "ProducerMSP") {
            adminUserId = produceradminUserId;
            adminUserPasswd = produceradminUserPasswd;
